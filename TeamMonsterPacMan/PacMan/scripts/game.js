...
var games = (function () {
    ...
    Game.prototype.restart = function () {
        ...
        theGhosts[0].position = {
            x: 12,
            y: 14
        };
        theGhosts[1].position = {
            x: 13,
            y: 14
        };
        theGhosts[2].position = {
            x: 14,
            y: 14
        };
        theGhosts[3].position = {
            x: 15,
            y: 14
        };
        theGhosts[4].position = {
            x: 16,
            y: 14
        };
        theGhosts[5].position = {
            x: 17,
            y: 14
        };
        theGhosts[6].position = {
            x: 12,
            y: 13
        };
        theGhosts[7].position = {
            x: 13,
            y: 13
        };
        theGhosts[8].position = {
            x: 14,
            y: 13
        };
        theGhosts[9].position = {
            x: 15,
            y: 13
        };
        theGhosts[10].position = {
            x: 16,
            y: 13
        };
        theGhosts[11].position = {
            x: 17,
            y: 13
        };
